...
func Room(c *fiber.Ctx) error {
	...
	return c.Render("peer", fiber.Map{
		...
		"ChatWebSocketAddr":   fmt.Sprintf("%s://%s/room/%s/chat/websocket", ws, c.Protocol(), c.Hostname(), uuid),
		"ViewerWebSocketAddr": fmt.Sprintf("%s://%s/room/%s/viewer/websocket", ws, c.Protocol(), c.Hostname(), uuid),
